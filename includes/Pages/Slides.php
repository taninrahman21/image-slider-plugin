...
<div class="tab-content" id="tab-slide">
  ...
  <!-- Div After Click Add New Slider -->
  <div id="add-new-slider-section" style="display: none;">
    <form action="admin.php?page=content-slider" method="POST" class="slide-name-form">
      <p>Enter Slider Name</p>
      <div>
        <input type="text" id="name" name="name" placeholder="Slider Name" required>
        <input type="submit" class="button button-primary" value="Save">
      </div>
    </form>

    <!-- Display and Add New Slides -->
    <div>
      Slides will Display here and you can add new slide
    </div>
  </div>
